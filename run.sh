...
for i in $`seq 1`; do 
	...
	#bin/crossdmd_robot 500 0 127.0.0.1 10023 127.0.0.1 10024 127.0.0.1 10025 127.0.0.1 10026 127.0.0.1 10027 127.0.0.1 10028 127.0.0.1 10029 127.0.0.1 10030; 
	bin/crossdmd_robot 5000 0 127.0.0.1 10023 127.0.0.1 10024; 
	#bin/crossdmd_robot 500 0 127.0.0.1 10023; 
done;
